// Bugfix: this.disabled_limit was replaced with t.disabled_limit
const multi = function () {
    var e = function (e, t) {
        ...
        if (n > -1) {
            ...
            if (a === n) {
                t.disabled_limit = !0, "function" == typeof t.limit_reached && t.limit_reached();
                for (i = 0; i < e.options.length; i++) {
                    (d = e.options[i]).selected || d.setAttribute("disabled", !0)
                }
            } else if (t.disabled_limit) {
                for (i = 0; i < e.options.length; i++) {
                    var d;
