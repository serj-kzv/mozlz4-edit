 ...
 *
 * How to use.
 * In the browser console type 'FetchGoogleParams.fetch()' then copy result to the app/resources/engines.json
 *
 * Resources
...
import WEB_EXT_API from '../app/js/lib/app/WebExtApi.js';
